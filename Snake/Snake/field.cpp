...
{
	LPCTSTR szWindowClass = "QWERTY";//имя класса
	WNDCLASSEX wcex;
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	HINSTANCE hInst = hInstance; // сохраняет указатель приложения в переменной hInst
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_PAINT:  // Перерисовать окно
		...
		DrawText(hdc, "Hello wold", -1, &rt, DT_SINGLELINE | DT_CENTER | DT_VCENTER);
